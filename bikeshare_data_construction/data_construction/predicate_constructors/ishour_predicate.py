...
def ishour_predicate(time_to_constant_dict, fold=0, setting="eval"):
    ...
    write_lines_to_predicate_file("psl_data/"+str(fold)+"/"+setting+"/ishour_obs.txt", ishour_predicate_lines)