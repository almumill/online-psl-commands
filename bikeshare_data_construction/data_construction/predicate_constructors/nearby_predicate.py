...
def nearby_predicate(station_df, threshold, fold=0, setting="eval"):
    ...
    write_lines_to_predicate_file("psl_data/" + str(fold) + "/" + str(setting) + "/nearby_obs.txt", nearby_predicate_lines)