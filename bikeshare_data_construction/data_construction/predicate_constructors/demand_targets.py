...
def demand_targets(truth_demand_df, time_to_constant_dict, time_step, fold='0', setting='eval'):
	...
	write_lines_to_predicate_file(path + "/demand_targets.txt", demand_targets_lines)