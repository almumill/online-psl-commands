...
def demand_truth(truth_demand_df, time_to_constant_dict, time_step, data_path, fold='0', setting='eval'):
	demand_truth_lines = []
	...
	write_lines_to_predicate_file(data_path + "demand_truth.txt", demand_truth_lines)