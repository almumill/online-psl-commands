...
def demand_predicate(obs_demand_df, time_to_constant_dict, time_step, data_path, fold='0', setting='eval', ts=0):
	...
	write_lines_to_predicate_file(os.path.join(data_path, str(fold), setting, str(ts), "demand_obs.txt"), demand_predicate_lines)