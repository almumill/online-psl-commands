...
def nearby_predicate(station_df, threshold, data_path, fold=0, setting="eval", ts=0):
    ...
    write_lines_to_predicate_file(os.path.join(data_path, str(fold), setting, str(ts), "nearby_obs.txt"), nearby_predicate_lines)