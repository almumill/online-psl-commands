...
def isweekend_predicate(time_to_constant_dict, time_step, fold='0', setting='eval'):
	...
	write_lines_to_predicate_file(path+"/isweekend_obs.txt", isweekend_predicate_lines)